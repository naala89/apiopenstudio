...
//$I->wantTo('Test a developer can delete a var for an account they are assigned to');
...
$I->wantTo('Test an administrator can delete a var from the apiopoenstudio account');
