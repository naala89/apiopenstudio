...
// phpcs:ignore
$html = "<!DOCTYPE html>\n<html lang=\"en-us\"><head><meta charset=\"utf-8\" /><title>HTML generated by ApiOpenStudio</title></head><body><div>3.141</div></body></html>";

$I->performLogin(getenv('TESTER_DEVELOPER_NAME'), getenv('TESTER_DEVELOPER_PASS'));
$yamlFilename = 'textFloat.yaml';
$uri = $I->getMyBaseUri() . '/text/float';
