...
$yamlFilename = 'floatNULL.yaml';
$uri = $I->getMyBaseUri() . '/float/null';
$I->createResourceFromYaml($yamlFilename);

// json - application/json
$I->wantTo('Test float null with accept: application/json.');
...
// xml - application/xml
$I->wantTo('Test float null with accept: application/xml.');
...
// xml - text/xml
$I->wantTo('Test float null with accept: text/xml.');
...
// text = text/plain
$I->wantTo('Test float null with accept: text/plain.');
...
// html = text/html
$I->wantTo('Test float null with accept: text/html.');
$html = "<!DOCTYPE html>\n";
