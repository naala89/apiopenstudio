...
$I->sendPOST('/' . $I->getMyApplicationName() . '/user/login', ['username' => $I->getMyUsername(), 'password' => $I->getMyPassword()]);
...
$I->haveHttpHeader('Accept', 'application/json');
$I->sendPOST('/' . $I->getMyApplicationName() . '/user/login', ['username' => $I->getMyUsername(), 'password' => 'badpassword']);
...
$I->haveHttpHeader('Accept', 'application/json');
$I->sendPOST('/' . $I->getMyApplicationName() . '/user/login', ['username' => 'badusername', 'password' => $I->getMyPassword()]);
$I->seeResponseCodeIs(401);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array(
  'error' => array(
