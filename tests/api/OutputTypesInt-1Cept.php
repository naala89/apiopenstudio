...
$yamlFilename = 'integer-1.yaml';
$uri = $I->getMyBaseUri() . '/integer/-1';
$I->createResourceFromYaml($yamlFilename);

// json - application/json
$I->wantTo('Test integer -1 with accept: application/json.');
...
// xml - application/xml
$I->wantTo('Test integer -1 with accept: application/xml.');
...
// xml - text/xml
$I->wantTo('Test integer -1 with accept: text/xml.');
...
// text = text/plain
$I->wantTo('Test integer -1 with accept: text/plain.');
...
$I->wantTo('Test integer -1 with accept: text/html.');
