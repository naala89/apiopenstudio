...
$I->seeResponseIsJson();
$I->seeResponseContainsJson(["field1","field2","field3","field4",1,5]);
...
$I->seeResponseIsJson();
$I->seeResponseContainsJson(["error" => ["code" => 1, "message" => "Cannot sort a collection of mixed name/value pairs and values." ,"id" => 3]]);
$I->tearDownTestFromYaml();
...
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(["field1","field2","field3","testStr",1,3.4562599999999999,5]);
$I->tearDownTestFromYaml();
...
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson([["key1" => "val99"], ["key2" => "val5"], ["key3" => "val3"], ["key4" => "val2"], ["key999" => "val1"]]);
...
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson([["key999" => "val1"], ["key4" => "val2"], ["key3" => "val3"], ["key2" => "val5"], ["key1" => "val99"]]);
