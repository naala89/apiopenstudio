...
$yamlFilename = 'integer-INF.yaml';
$uri = $I->getMyBaseUri() . '/integer/-inf';
$I->createResourceFromYaml($yamlFilename);

// json - application/json
$I->wantTo('Test integer -INF with accept: application/json.');
...
// xml - application/xml
$I->wantTo('Test integer -INF with accept: application/xml.');
...
// xml - text/xml
$I->wantTo('Test integer -INF with accept: text/xml.');
...
// text = text/plain
$I->wantTo('Test integer -INF with accept: text/plain.');
...
// html = text/html
$I->wantTo('Test integer -INF with accept: text/html.');
$html = "<!DOCTYPE html>\n";
