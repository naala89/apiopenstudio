...
$I->seeResponseIsJson();
$I->seeResponseContainsJson(['error' => ['code' => 6, 'message' => 'URI index "text" does not exist.', 'id' => 3]]);

$I->wantTo('populate a varUri with true and see the result.');
$I->sendGet($uri . '/index1/index2', ['token' => $I->getMyStoredToken(), 'index' => 'true']);
$I->seeResponseCodeIs(417);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(['error' => ['code' => 6, 'message' => 'URI index "true" does not exist.', 'id' => 3]]);

$I->wantTo('populate a varUri with 1.6 and see the result.');
$I->sendGet($uri . '/index1/index2', ['token' => $I->getMyStoredToken(), 'index' => '1.6']);
$I->seeResponseCodeIs(417);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(['error' => ['code' => 6, 'message' => 'URI index "1.6" does not exist.', 'id' => 3]]);
