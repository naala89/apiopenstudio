...
$yamlFilename = 'booleanTrue.yaml';
$uri = $I->getMyBaseUri() . '/boolean/true';
$I->createResourceFromYaml($yamlFilename);

// json - application/json
$I->wantTo('Test boolean true with accept: application/json.');
...
// xml - application/xml
$I->wantTo('Test boolean true with accept: application/xml.');
...
// xml - text/xml
$I->wantTo('Test boolean true with accept: text/xml.');
...
// text = text/plain
$I->wantTo('Test boolean true with accept: text/plain.');
...
$html .= '<body><div>true</div></body></html>';
$I->wantTo('Test boolean true with accept: text/html.');
