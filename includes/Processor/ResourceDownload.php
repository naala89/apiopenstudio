...
class ResourceDownload extends Core\ProcessorEntity
{
    /**
     * @var Config
     */
    ...
    protected $details = [
        ...
        'machineName' => 'resource_download',
        'description' => 'Download a resource file. Requires a header of "Accept: application/octet-stream"',
        'menu' => 'Admin',
        'input' => [
            'resid' => [
