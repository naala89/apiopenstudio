 ...
 * Class ModulesUninstall
 *
 * Processor class to run uninstall() for a module.
 */
class ModulesUninstall extends ProcessorEntity
{
    /**
     * {@inheritDoc}
     *
    ...
    protected array $details = [
        ...
        'machineName' => 'modules_uninstall',
        'description' => 'Uninstall one or more 3rd party modules.',
        'menu' => 'Admin',
        'input' => [
            'machine_name' => [
    ...
    public function process(): DataContainer
    {
        ...
        try {
            $result = $this->moduleHelper->uninstall($machineName);
        } catch (ApiException $e) {
            throw new ApiException($e->getMessage(), $e->getCode(), $this->id, $e->getHtmlCode());
        }
