...
INSERT INTO `resource` (`id`, `appid`, `name`, `description`, `method`, `identifier`, `meta`, `ttl`) VALUES
  (1, 1, 'Account create', 'Create an account.', 'post', 'account', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varPost","id":2,"name":"token"}},"process":{"function":"datagatorAccount","id":3,"username":{"function":"varPost","id":4,"name":"username"},"accountName":{"function":"varPost","id":5,"name":"accountName"}}}', 0),
  (2, 1, 'Account delete', 'Delete an account.', 'delete', 'account', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"datagatorAccount","id":3,"accountName":{"function":"varGet","id":4,"name":"accountName"}}}', 0),
  (3, 1, 'Account fetch', 'Fetch an account.', 'get', 'account', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"datagatorAccount","id":3,"accountName":{"function":"varGet","id":4,"name":"accountName"}}}', 0),
  (4, 1, 'Application create', 'Create an application.', 'post', 'application', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varPost","id":2,"name":"token"}},"process":{"function":"datagatorApplication","id":3,"accountName":{"function":"varPost","id":4,"name":"accountName"},"applicationName":{"function":"varPost","id":5,"name":"applicationName"}}}', 0),
  (5, 1, 'Application delete', 'Delete an application.', 'delete', 'applicaton', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"datagatorApplication","id":3,"applicationName":{"function":"varGet","id":5,"name":"applicationName"}}}', 0),
  (6, 1, 'Application fetch', 'Fetch an application.', 'get', 'application', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"datagatorApplication","id":3,"applicationName":{"function":"varGet","id":5,"name":"applicationName"}}}', 0),
  (7, 2, 'Processors all', 'Fetch details of all procssors.', 'get', 'processors/all', '{"security":{"function":"tokenDeveloper","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"ProcessorsAll","id":3}}', 3600),
  (8, 2, 'Resource delete', 'Delete a resource.', 'delete', 'resource', '{"security":{"function":"tokenDeveloper","id":1,"token":{"function":"varRequest","id":2,"name":"token"}},"process":{"function":"resourceYaml","id":3,"method":{"function":"varRequest","id":4,"name":"method"},"uri":{"function":"varRequest","id":5,"name":"uri"}}}', 0),
  (9, 2, 'Resource export JSON', 'Export a resource in string or JSON format.', 'get', 'resource/json', '{"security":{"function":"tokenDeveloper","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"resourceJson","id":3,"method":{"function":"varGet","id":4,"name":"method"},"noun":{"function":"varGet","id":5,"name":"noun"},"verb":{"function":"varGet","id":6,"name":"verb"}}}', 0),
  (10, 2, 'Resource export YAML', 'Fetch a resource in string or YAML format.', 'get', 'resource/yaml', '{"security":{"function":"tokenDeveloper","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"resourceYaml","id":3,"method":{"function":"varGet","id":4,"name":"method"},"noun":{"function":"varGet","id":5,"name":"noun"},"verb":{"function":"varGet","id":6,"name":"verb"}}}', 0),
  (11, 2, 'Resource import JSON', 'Create a resource from a document or string in JSON format.', 'post', 'resource/json', '{"security":{"function":"tokenDeveloper","id":1,"token":{"function":"varPost","id":2,"name":"token"}},"process":{"function":"resourceJson","id":3,"yaml":{"function":"varPost","id":4,"name":"yaml"}}}', 0),
  (12, 2, 'Resource import Swagger', 'Create resource/s from a Swagger document.', 'post', 'resource/swagger', '{"security":{"function":"tokenDeveloper","id":1,"token":{"function":"varPost","id":2,"name":"token"}},"process":{"function":"resourceSwagger","id":3,"resource":"resource"}}', 0),
  (13, 2, 'Resource import YAML', 'Create a resource from a document or string in YAML format.', 'post', 'resource/yaml', '{"security":{"function":"tokenDeveloper","id":1,"token":{"function":"varPost","id":2,"name":"token"}},"process":{"function":"resourceYaml","id":3,"resource":"resource"}}', 0),
  (14, 1, 'User create', 'Create a user.', 'post', 'user', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varPost","id":2,"name":"token"}},"process":{"function":"datagatorUser","id":3,"username":{"function":"varPost","id":4,"name":"username"},"active":{"function":"varPost","id":5,"name":"active"},"email":{"function":"varPost","id":6,"name":"email"},"honorific":{"function":"varPost","id":7,"name":"honorific"},"nameFirst":{"function":"varPost","id":8,"name":"nameFirst"},"nameLast":{"function":"varPost","id":9,"name":"nameLast"},"company":{"function":"varPost","id":10,"name":"company"}}}', 0),
  (15, 1, 'User delete', 'Delete a user.', 'delete', 'user', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"datagatorUser","id":3,"username":{"function":"varGet","id":4,"name":"username"}}}', 0),
  (16, 1, 'User fetch', 'Fetch a user.', 'get', 'user', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"datagatorUser","id":3,"username":{"function":"varGet","id":4,"name":"username"}}}', 0),
  (17, 2, 'User login', 'Login a user to Datagator using username/password.', 'post', 'user/login', '{"process":{"function":"UserLogin","id":1,"username":{"function":"VarPost","id":2,"name":"username"},"password":{"function":"VarPost","id":3,"name":"password"}}}', 0),
  (18, 2, 'User login Drupal', 'Login a user to the system, using user/pass validation on an external Drupal site', 'post', 'user/login/drupal', '{"process":{"function":"loginStoreDrupal","id":1,"source":{"function":"url","id":2,"source":{"function":"concatenate","id":3,"sources":[{"function":"varPersistent","id":4,"name":"drupalUrl","operation":"fetch"},"api\\/anon\\/user\\/login"]},"method":"post","reportError":true,"normalise":true,"vars":{"username":{"function":"varPost","id":5,"name":"username"},"password":{"function":"varPost","id":6,"name":"password"}},"curlOpts":{"CURLOPT_SSL_VERIFYPEER":0,"CURLOPT_FOLLOWLOCATION":1}}}}', 0),
  (19, 1, 'User Role create', 'Add a role for a user for an application.', 'post', 'userrole', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varPost","id":2,"name":"token"}},"process":{"function":"datagatorUserRole","id":3,"username":{"function":"varPost","id":4,"name":"username"},"applicationName":{"function":"varPost","id":5,"name":"applicationName"},"roleName":{"function":"varPost","id":6,"name":"roleName"}}}', 0),
  (20, 1, 'User Role delete', 'Delete a role for a user and/or application.', 'delete', 'userrole', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"datagatorUserRole","id":3,"username":{"function":"varGet","id":4,"name":"username"},"applicationName":{"function":"varGet","id":5,"name":"applicationName"},"roleName":{"function":"varPost","id":6,"name":"roleName"}}}', 0),
  (21, 1, 'User Role fetch', 'Fetch a role for a user on an application.', 'get', 'userrole', '{"security":{"function":"TokenSysAdmin","id":1,"token":{"function":"varGet","id":2,"name":"token"}},"process":{"function":"datagatorUserRole","id":3,"username":{"function":"varGet","id":4,"name":"username"},"applicationName":{"function":"varGet","id":5,"name":"applicationName"},"roleName":{"function":"varPost","id":6,"name":"roleName"}}}', 0);
...
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
ALTER TABLE `resource`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'resource id',AUTO_INCREMENT=48;
ALTER TABLE `role`
