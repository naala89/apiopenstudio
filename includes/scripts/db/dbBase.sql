...
INSERT INTO `resource` (`id`, `appid`, `name`, `description`, `method`, `identifier`, `meta`, `ttl`) VALUES
  ...
  (86, 1, 'User Role create', 'Add a role for a user for an application.', 'post', 'userrolemanage', '{"security":{"processor":"TokenSysAdmin","meta":{"id":1,"token":{"processor":"varPost","meta":{"id":2,"name":"token"}}}},"process":{"processor":"datagatorUserRole","meta":{"id":3,"username":{"processor":"varPost","meta":{"id":4,"name":"username"}},"applicationName":{"processor":"varPost","meta":{"id":5,"name":"applicationName"}},"roleName":{"processor":"varPost","meta":{"id":6,"name":"roleName"}}}}}', 0),
  (87, 1, 'User Role delete', 'Delete a role for a user and/or application.', 'delete', 'userrolemanage', '{"security":{"processor":"TokenSysAdmin","meta":{"id":1,"token":{"processor":"varGet","meta":{"id":2,"name":"token"}}}},"process":{"processor":"datagatorUserRole","meta":{"id":3,"username":{"processor":"varGet","meta":{"id":4,"name":"username"}},"applicationName":{"processor":"varGet","meta":{"id":5,"name":"applicationName"}},"roleName":{"processor":"varPost","meta":{"id":6,"name":"roleName"}}}}}', 0),
  (88, 1, 'User Role fetch', 'Fetch a role for a user on an application.', 'get', 'userrolemanage', '{"security":{"processor":"TokenSysAdmin","meta":{"id":1,"token":{"processor":"varGet","meta":{"id":2,"name":"token"}}}},"process":{"processor":"datagatorUserRole","meta":{"id":3,"username":{"processor":"varGet","meta":{"id":4,"name":"username"}},"applicationName":{"processor":"varGet","meta":{"id":5,"name":"applicationName"}},"roleName":{"processor":"varPost","meta":{"id":6,"name":"roleName"}}}}}', 0),
  (99, 2, 'Account create', 'Create an account.', 'post', 'accountmanage', '{"security":{"processor":"TokenSysAdmin","meta":{"id":1,"token":{"processor":"varPost","meta":{"id":2,"name":"token"}}}},"process":{"processor":"datagatorAccount","meta":{"id":3,"username":{"processor":"varPost","meta":{"id":4,"name":"username"}},"accountName":{"processor":"varPost","meta":{"id":5,"name":"accountName"}}}}}', 0);
...
INSERT INTO `user` (`uid`, `active`, `username`, `salt`, `hash`, `token`, `token_ttl`, `email`, `honorific`, `name_first`, `name_last`, `company`, `website`, `address_street`, `address_suburb`, `address_city`, `address_state`, `address_postcode`, `phone_mobile`, `phone_work`) VALUES
  (1, 1, 'john', '…•›#¼J5¼>ôpé2', 'afb1c00e97f5b8503197cb61ffecebb5', 'ad860b94cc68b88247345407060ecd42', '2016-05-18 23:17:40', 'john@naala.com.au', 'Mr', 'John', 'Avery', 'Naala Pty Ltd', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  ...
  (9, 1, 'tester', 'º	K_ VÐÕÎ˜d\rù', 'ce45c312b0d34dd876bd039133510718', 'ceb6ec58076b5db2c6b4b9e3264ed885', '2016-05-17 22:51:46', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
ALTER TABLE `application`
MODIFY `appid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'application id',AUTO_INCREMENT=14;
ALTER TABLE `blacklist`
...
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
ALTER TABLE `resource`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'resource id',AUTO_INCREMENT=100;
ALTER TABLE `role`
MODIFY `rid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'role id',AUTO_INCREMENT=6;
ALTER TABLE `user`
MODIFY `uid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'user id',AUTO_INCREMENT=10;
ALTER TABLE `user_role`
